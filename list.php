...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
      <div class="container">
        <h1 class = "mt-2 mb-2">Completed questionnaire table</h1>
          <input type="text" onkeyup="myFunction()" id = "inputText"class="mt-2 mb-2 form-control" placeholder="Enter questionnaire name to search for...">
